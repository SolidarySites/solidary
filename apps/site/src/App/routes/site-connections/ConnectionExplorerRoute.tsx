...
import { useConnectionExplorerRouteController } from "./hooks/useConnectionExplorerRouteController";
import "./ConnectionExplorerRoute.css";
...
export default function ConnectionExplorerRoute() {
  const controller = useConnectionExplorerRouteController();
  ...
  return (
    <div className="app-shell">
      <main className="main-content">
        <section className="connection-explorer-card">
          <div className="section-heading">
            <div>
              <p className="connection-explorer-eyebrow">Site settings</p>
              <h2>Connection explorer</h2>
              <p>Invite other sites to connect, then review incoming requests and approve/reject them.</p>
            </div>
            <button type="button" className="ghost" onClick={controller.onBackToBuilder}>
              Back to builder
            </button>
          </div>
              ...
              {controller.canManageConnections && (
                <>
                  ...
                  <section className="connection-explorer-panel">
                    ...
                    {controller.requestsError && <p className="connection-explorer-error">{controller.requestsError}</p>}
                            ...
                            <article key={request.requestId} className="connection-request-card">
                              ...
                              <div className="connection-request-actions">
                                <button
                                  ...
                                  onClick={() => controller.onRespondToRequest(request.requestId, "approve")}
                                >
                                ...
                                <button
                                  ...
                                  className="ghost"
                                  disabled={isResponding}
                                  onClick={() => controller.onRespondToRequest(request.requestId, "reject")}
                                >
                                  Reject
                                </button>
                              </div>
