-- Allow settings-specific optimistic lock keys for Studio Settings sections.
-- These keys are used by /studio/settings:
--   settings:general, settings:connections, settings:collaborators, settings:danger
