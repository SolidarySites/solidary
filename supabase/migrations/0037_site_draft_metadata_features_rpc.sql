...
drop function if exists public.site_draft_upsert_settings_metadata(uuid, text, text, text, jsonb);
...
revoke all on function public.site_draft_upsert_settings_metadata(uuid, text, text, text, jsonb) from public;
grant execute on function public.site_draft_upsert_settings_metadata(uuid, text, text, text, jsonb) to authenticated;
